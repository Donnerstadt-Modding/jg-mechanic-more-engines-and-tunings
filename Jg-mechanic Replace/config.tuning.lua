...
turbocharging = {
    ...
    [2] = {
        name = "Sport Turbo",
        icon = "turbo.svg",
        info = "Leistungsstarker Sportturbo mit schnellem Ansprechverhalten.",
        itemName = "sport_turbo",
        price = 12000,
        handlingOverwritesValues = true,
        handlingApplyOrder = 2,
        handling = {
    ...
    [3] = {
        name = "Stage 3 Turbo",
        icon = "turbo.svg",
        info = "Hochleistungs-Turbolader mit deutlichem Drehmomentzuwachs.",
        itemName = "stage3_turbo",
        price = 18000,
        handlingOverwritesValues = true,
        handlingApplyOrder = 3,
        handling = {
            fInitialDriveForce = 1.35,
    ...
    [4] = {
        name = "Racing Turbo",
        icon = "turbo.svg",
        info = "Rennsport-Turbolader – extrem hohe Leistung, etwas Turbolag.",
        itemName = "racing_turbo",
        price = 25000,
        handlingOverwritesValues = true,
        handlingApplyOrder = 4,
        handling = {
            fInitialDriveForce = 1.45,
    ...
    [5] = {
        name = "Twin Turbo",
        icon = "turbo.svg",
        info = "Doppelturbolader – hervorragendes Ansprechverhalten und Spitzenleistung.",
        itemName = "twin_turbo",
        price = 30000,
        handlingOverwritesValues = true,
        handlingApplyOrder = 5,
    ...
    [6] = {
        name = "Pro Turbo Kit",
        icon = "turbo.svg",
        info = "Professionelles Kit mit großem Lader, hoher Boost-Leistung – Renntechnik pur.",
        itemName = "pro_turbo",
        price = 40000,
        handlingOverwritesValues = true,
        handlingApplyOrder = 6,
        handling = {
            fInitialDriveForce = 1.7,
