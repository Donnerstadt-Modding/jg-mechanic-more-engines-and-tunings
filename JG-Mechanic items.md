...
["porsche_v12"] = {
    label = "Porsche Carrera V12",
    weight = 500,
    stack = false,
    close = true,
    description = "Ein seltener V12 aus dem Hause Porsche mit extrem hoher Leistung und sportlicher Präzision."
},

["audi_rs3_i5"] = {
    label = "Audi RS3 EA855 I5",
    weight = 500,
    stack = false,
    close = true,
    description = "Der bekannte 5-Zylinder Turbo liefert aggressiven Sound und starke Beschleunigung."
},

["audi_rs4_v8"] = {
    label = "Audi RS4 Coupe 4.2L FSI",
    weight = 500,
    stack = false,
    close = true,
    description = "Ein hochdrehender V8-Saugmotor mit direkter Gasannahme und sportlichem Charakter."
},

["lambo_aventador_v12"] = {
    label = "Lamborghini Aventador V12",
    weight = 500,
    stack = false,
    close = true,
    description = "Ein ikonischer V12 mit brachialer Leistung und unverwechselbarem Lamborghini Sound."
},

["lambo_v10"] = {
    label = "Lamborghini 5.2L V10",
    weight = 500,
    stack = false,
    close = true,
    description = "Ein hochdrehender V10 mit perfekter Balance aus Leistung und Kontrolle."
},

["lambo_veneno_v12"] = {
    label = "Lamborghini Veneno V12",
    weight = 500,
    stack = false,
    close = true,
    description = "Ein extrem seltener High-Performance V12 mit maximaler Rennsport-DNA."
},

["lambo_countach_v12"] = {
    label = "Lamborghini Countach V12",
    weight = 500,
    stack = false,
    close = true,
    description = "Legendärer V12 Klassiker mit einzigartigem Sound und ikonischem Design."
},
...
["amg_e55_v8"] = {
    ...
    stack = false,
    close = true,
    description = "Ein aufgeladener AMG V8 mit massivem Drehmoment und brutaler Durchzugskraft."
},

["honda_nsx_v6"] = {
    label = "Honda NSX V6 C30A",
    weight = 500,
    stack = false,
    close = true,
    description = "Ein zuverlässiger und hochdrehender V6 aus Japans Sportwagenlegende."
},
...
["lexus_lfa_v10"] = {
    ...
    stack = false,
    close = true,
    description = "Ein legendärer Hochdrehzahl-V10 mit einzigartigem Formel-1 ähnlichem Sound."
},
...
["harley_vtwin"] = {
    ...
    stack = false,
    close = true,
    description = "Ein klassischer V-Twin Motor mit unverwechselbarem Klang und Charakter."
},

["aston_zagato_v12"] = {
    label = "Aston Martin Zagato V12",
    weight = 500,
    stack = false,
    close = true,
    description = "Ein eleganter V12 mit britischer Performance und exklusivem Fahrgefühl."
},

["audi_rs6_v8"] = {
    label = "Audi RS6 EA825 V8",
    weight = 500,
    stack = false,
    close = true,
    description = "Ein moderner Biturbo V8 mit enormer Leistung und Allround-Performance."
},
...
["audi_rs7_2021"] = {
    ...
    stack = false,
    close = true,
    description = "Ein High-End Performance Motor mit luxuriösem Fahrgefühl und brachialer Power."
},
